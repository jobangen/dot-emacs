...
;;     ((t :background "#ffbbff" :weight bold)))
   ...
   `(default ((,class (:slant normal :foreground "#333333" :background "#FFFFFF" :inherit 'fixed-pitch))))
   ...
   `(fixed-pitch ((,class (:family "Ubuntu Mono"))))
...
;   `(org-code ((,class ,code-inline)))
   ...
   `(org-date ((,class ,link)))
;   `(org-default ((,class (:foreground "#333333" :background "#FFFFFF" :family "Helvetica Neue" :inherit 'variable-pitch))))
