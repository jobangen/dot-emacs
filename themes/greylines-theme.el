...
(let ((class '((class color) (min-colors 89)))
      ...
      (ol1 '(:height 1.0 :weight bold :slant normal :overline "#808080" :foreground "#191919" :background "#f3f3f3"))
      ...
      (ol6 '(:height 1.0 :weight bold :foreground ""))
      (ol7 '(:height 1.0 :slant italic :foreground ""))
      (ol8 '(:height 1.0 :slant italic :foreground ""))
...
;   `(org-document-title ((,class (:family "Sans Serif" :height 1.8 :weight bold :foreground "black"))))
   ...
   `(org-drawer ((,class (:foreground "black"))))
