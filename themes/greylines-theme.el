...
;   `(org-sexp-date ((,class (:foreground "#3774CC"))))
   ...
   `(org-table ((,class :family "Ubuntu Mono" :foreground "#001efd")))
...
;; Latex
   ...
   `(font-latex-sectioning-1-face ((,class (:family "Sans Serif" :height 1.3 :weight bold :foreground "cornflower blue"))))
   `(font-latex-sectioning-2-face ((,class (:family "Sans Serif" :height 1.2 :weight bold :foreground "cornflower blue"))))
   `(font-latex-sectioning-3-face ((,class (:family "Sans Serif" :height 1.1 :weight bold :foreground "cornflower blue"))))
