...
(let ((class '((class color) (min-colors 89)))
      ...
      (ol1 '(:height 1.0 :weight bold :slant normal :foreground "#252525" :background "#f3f3f3"))
      (ol2 '(:height 1.0 :weight bold :foreground "#1e2294"))
      (ol3 '(:height 1.0 :weight bold :foreground "#272cbe"))
      (ol4 '(:height 1.0 :weight bold :foreground "#4045d8"))
      (ol5 '(:height 1.0 :weight bold :foreground "#6a6ee1"))
      (ol6 '(:height 1.0 :weight bold :foreground "#6a6ee1"))
      (ol7 '(:height 1.0 :slant italic :foreground "#6a6ee1"))
      (ol8 '(:height 1.0 :slant italic :foreground "#6a6ee1"))
...
;;     ((t :background "#ffbbff" :weight bold)))
   ...
   `(italic ((,class (:slant italic :family "Ubuntu Mono" :foreground "#1A1A1A"))))
...
;   `(org-sexp-date ((,class (:foreground "#3774CC"))))
   ...
   `(org-tag ((,class (:weight normal :slant italic)))) ;;Formatierung der tags
