...
(let ((class '((class color) (min-colors 89)))
      ...
      (column '(:height 1.0 :weight normal :slant normal :underline nil :strike-through nil :foreground "#191919" :background "#f3f3f3"))
      (diff-added '(:foreground "#004000" :background "#bbfebb"))
      ...
      (mail-old '(:weight normal :foreground "#6b6c6f"))
      (mail-ticked '(:weight bold :foreground "#0080ff"))
      (mail-to '(:underline nil :foreground "#006DAF"))
      (mail-unread '(:weight bold :foreground "magenta4"))
      (marked-line '(:weight bold :foreground "red" :background "pink"))
      (match '(:box (:line-width 1 :color "black") :weight bold :background "#FFF876")) ; occur patterns
      (ol1 '(:height 1.0 :weight bold :foreground "#191919" :inherit fixed-pitch))
      (ol2 '(:height 1.0 :weight bold :foreground "#191919" :inherit fixed-pitch))
      (ol3 '(:height 1.0 :weight bold :foreground "#191919" :inherit fixed-pitch))
      (ol4 '(:height 1.0 :weight bold :foreground "#191919" :inherit fixed-pitch))
      (ol5 '(:height 1.0 :weight bold :foreground "#191919" :inherit fixed-pitch))
      (ol6 '(:height 1.0 :weight bold :foreground "#191919" :inherit fixed-pitch))
      (ol7 '(:height 1.0 :weight bold :foreground "#191919" :inherit fixed-pitch))
      (ol8 '(:height 1.0 :weight bold :foreground "#191919" :inherit fixed-pitch))
      (paren-matched '(:background "#99CCFF"))
      (paren-unmatched '(:underline "red" :foreground nil :background "#FFDCDC"))
      (region '(:background "#ABDFFA"))
      (shadow '(:foreground "#e4e4e4"))
      ;;       "#e4e4e4"
      (string '(:foreground "#D0372D" :inherit 'fixed-pitch)) ; or #D0372D, #008000
...
;;; swiper
  ...
  `(default ((,class (:slant normal :foreground ,tufte-fg :background ,tufte-bg))))
  `(bold ((,class (:weight bold))))
  `(bold-italic ((,class (:weight bold :slant italic))))
  `(italic ((,class (:slant italic))))
  `(underline ((,class (:underline t))))
  `(cursor ((,class (:background "#0FB300"))))
  `(variable-pitch ((,class (:family "ETBembo" :height 140 :weight thin))))
...
;;; Flyspell.
  ...
  (if (version< emacs-version "24.4")
      `(flyspell-incorrect ((,class (:underline (:style wave :color "red" :weight bold) :inherit nil)))))
     
;;; writegood-faces
  `(writegood-weasels-face ((,class (:background "#CECEF6" :underline nil))))
  `(writegood-passive-voice-face ((,class (:background "#F5A9A9"))))
  `(writegood-duplicates-face ((,class (:strike-through t))))

;;; Org-Mode 
  `(org-agenda-block-count ((,class (:weight bold :foreground "#A5A5A5"))))
  `(org-agenda-calendar-event ((,class (:weight bold :foreground ,tufte-fg))))
  ...
  `(org-agenda-current-time ((,class (:weight bold :foreground ,tufte-fg))))
  `(org-agenda-date ((,class (:weight bold :foreground "#1662AF"))))
  `(org-agenda-date-today ((,class (:font ,tufte-sans-serif-font :height 1.1 :foreground ,tufte-fg))))
  `(org-agenda-date-weekend ((,class (:weight bold :foreground "#4E4E4E"))))
  `(org-agenda-diary ((,class (:weight bold :foreground ,tufte-fg ))))
  `(org-agenda-dimmed-todo-face ((,class (:background "light grey"))))
  ...
  `(org-agenda-structure ((,class (:font ,tufte-sans-serif-font :height 1.2 :foreground ,tufte-fg ))))
  ...
  `(org-date ((,class ,link)))
  ;;   `(org-default ((,class (:foreground "#333333" :background "#FFFFFF" :inherit 'fixed-pitch))))
                                        ;   `(org-dim ((,class (:foreground "#AAAAAA"))))
                                        ;   `(org-document-info ((,class (:foreground "#484848"))))
  `(org-document-info-keyword ((,class (:foreground ,tufte-light))))
  `(org-document-title ((,class (:font ,tufte-sans-serif-font :height 1.2 :foreground ,tufte-fg :line-height 600))))
  `(org-done ((,class (:weight semi-light :foreground "forest green"))))
  `(org-drawer ((,class (:foreground ,tufte-vlight))))
  `(org-ellipsis ((,class (:foreground ,tufte-light)))) ; #FFEE62
   ...
   `(org-headline-done ((,class (:weight semi-light :foreground ,tufte-light))))
  `(org-hide ((,class (:foreground "#fbf8f0"))))`
  `(org-indent ((,class (:inherit fixed-pitch))))
  ...
  `(org-level-1 ((,class (:foreground ,tufte-fg :weight bold))))
  `(org-level-2 ((,class (:foreground ,tufte-fg :weight bold))))
  `(org-level-3 ((,class (:foreground ,tufte-fg :weight bold))))
  `(org-level-4 ((,class (:foreground ,tufte-fg :weight bold))))
  `(org-level-5 ((,class (:foreground ,tufte-fg :weight bold))))
  `(org-level-6 ((,class (:foreground ,tufte-fg :weight bold))))
  `(org-level-7 ((,class (:foreground ,tufte-fg :weight bold))))
  `(org-level-8 ((,class (:foreground ,tufte-fg :weight bold))))
  `(org-link ((,class ,link)))
                                        ;   `(org-list-dt ((,class (:weight bold :foreground "#335EA8"))))
                                        ;   `(org-macro ((,class (:weight bold :foreground "#EDB802"))))
  `(org-meta-line ((,class (:foreground ,tufte-light))))
  ...
  `(org-superstar-leading ((,class (:height 130 :foreground "#cccccc" :weight normal))))
  `(org-superstar-header-bullet ((,class :height 130 :foreground "#666666" :weight normal)))
...
;;; Latex
  ...
  `(font-latex-sectioning-1-face ((,class (:family "Sans Serif" :height 1.05 :weight bold :foreground "cornflower blue"))))
  `(font-latex-sectioning-2-face ((,class (:family "Sans Serif" :height 1.05 :weight bold :foreground "cornflower blue"))))
  `(font-latex-sectioning-3-face ((,class (:family "Sans Serif" :height 1.0 :weight bold :foreground "cornflower blue"))))
  `(font-latex-sectioning-4-face ((,class (:family "Sans Serif" :height 1.0 :weight bold :foreground "cornflower blue"))))
  `(font-latex-sectioning-5-face ((,class (:family "Sans Serif" :height 1.0 :weight bold :foreground "cornflower blue"))))
  `(font-latex-sedate-face ((,class (:foreground "#FF5500"))))
  `(font-latex-string-face ((,class (:weight bold :foreground "#0066FF"))))
  `(font-latex-verbatim-face ((,class (:foreground "#000088" :background "#FFFFE0"))))

;;; mu4e 
  `(mu4e-title-face ((,class (:font ,tufte-sans-serif-font))))
  `(mu4e-header-title-face ((,class (:foreground "forest green"))))
  `(mu4e-highlight-face ((,class (:weight bold :foreground "forest green"))))
...
;;; Font lock faces.
                                        ...
                                        ;   `(font-lock-variable-name-face ((,class (:weight normal :foreground "#BA36A5" :inherit 'fixed-pitch)))) ; #800080
...
;;; Gnus faces.
  ...
  `(gnus-header-from ((,class (:weight bold :foreground "black"))))
  ...
  `(gnus-summary-normal-ancient ((,class ,mail-old)))
...
;;; Calfw
  ;;   `(cfw:face-title ((,class (:foreground "#f0dfaf" :weight bold :height 2.0 :inherit variable-pitch))))
  ;;   `(cfw:face-header ((,class (:foreground "#d0bf8f" :weight bold))))
  ;;   `(cfw:face-sunday ((,class :foreground "#cc9393" :background "grey10" :weight bold)))
  ;;   `(cfw:face-saturday ((,class :foreground "#8cd0d3" :background "grey10" :weight bold)))
  ;;   `(cfw:face-holiday ((,class :background "grey10" :foreground "#8c5353" :weight bold)))
  ;;   `(cfw:face-grid ((,class :foreground "DarkGrey")))
  ;;   `(cfw:face-default-content ((,class :foreground "#bfebbf")))
  ;;   `(cfw:face-periods ((,class :foreground "cyan")))
  ;;   `(cfw:face-day-title ((,class :background "grey10")))
  ...
  ;;   `(cfw:face-today-title ((,class :background "#7f9f7f" :weight bold)))
  ;;   `(cfw:face-today ((,class :background: "grey10" :weight bold)))
  ;;   `(cfw:face-select ((,class :background "#2f2f2f")))
  `(cfw:face-toolbar ((,class :foreground "#36648b")))
  ;;   `(cfw:face-toolbar-button-off ((,class :foreground "Gray10" :weight bold)))
  ;;   `(cfw:face-toolbar-button-on ((,class :foreground "Gray50" :weight bold)))
...
;;;;; Semantic faces.
  ...
  `(dired-subtree-depth-1-face ((,class ,directory)))
  `(dired-subtree-depth-2-face ((,class ,directory)))
  `(dired-subtree-depth-3-face ((,class ,directory)))
  ...
  `(hl-line ((,class :background ,tufte-hl-bg)))
  ...
  `(linum ((,class (:foreground "#9A9A9A" :background "#EDEDED" :inherit 'fixed-pitch :height 1.0))))
...
;;; magit
  ...
  `(diff-refine-added ((, class (:foreground "#004000" :background "#57fe57"))))
  `(diff-refine-removed ((, class (:foreground "#840000" :background "#ff8888"))))
   
                                        ;   `(magit-diff-del ((,class ,diff-removed)))
                                        ;   `(magit-diff-file-header ((,class (:family "Sans Serif" :height 1.0 :weight bold :foreground "#4183C4"))))
                                        ...
                                        ;   `(magit-section-title ((,class (:family "Sans Serif" :height 1.2 :weight bold :foreground "cornflower blue" :inherit nil))))
  ...
  `(rainbow-delimiters-depth-5-face ((,class (:foreground "dark green"))))
  `(rainbow-delimiters-depth-6-face ((,class (:foreground "orchid"))))
  `(rainbow-delimiters-depth-7-face ((,class (:foreground "spring green"))))
  `(rainbow-delimiters-depth-8-face ((,class (:foreground "sienna1"))))
