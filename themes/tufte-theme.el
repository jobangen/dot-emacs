...
(let ((class '((class color) (min-colors 89)))
      ...
      (ol1 '(:height 1.0 :weight bold :foreground "#000050" :inherit fixed-pitch))
      (ol2 '(:height 1.0 :weight bold :foreground "#000050" :inherit fixed-pitch))
      (ol3 '(:height 1.0 :weight bold :foreground "#000050" :inherit fixed-pitch))
      (ol4 '(:height 1.0 :weight bold :foreground "#000050" :inherit fixed-pitch))
      (ol5 '(:height 1.0 :weight bold :foreground "#000050" :inherit fixed-pitch))
      (ol6 '(:height 1.0 :weight bold :foreground "#000050":inherit fixed-pitch))
      (ol7 '(:height 1.0 :weight bold :foreground "#000050" :inherit fixed-pitch))
      (ol8 '(:height 1.0 :weight bold :foreground "#000050" :inherit fixed-pitch))
...
;;     ((t :background "#ffbbff" :weight bold)))
   ...
   `(default ((,class (:slant normal :foreground "#111111" :background "#fbf8f0"))))
   `(bold ((,class (:weight bold))))
   `(bold-italic ((,class (:weight bold :slant italic))))
   `(italic ((,class (:slant italic :family "Ubuntu Mono"))))
...
;; Org-Mode 
   ...
   `(org-agenda-calendar-event ((,class (:weight normal :foreground "black"))))
   ...
   `(org-agenda-current-time ((,class (:foreground "#1662AF"))))
...
;   `(org-document-title ((,class (:family "Sans Serif" :height 1.8 :weight bold :foreground "black"))))
   ...
   `(org-drawer ((,class (:foreground "#999999"))))
...
;   `(org-macro ((,class (:weight bold :foreground "#EDB802"))))
   `(org-meta-line ((,class (:slant normal :foreground "#6e6e6e"))))
...
;   `(org-number-of-items ((,class (:weight bold :foreground "white" :background "#79BA79"))))
   `(org-property-value ((,class (:foreground "#001efd"))))
...
;   `(org-sexp-date ((,class (:foreground "#3774CC"))))
   `(org-special-keyword ((,class (:weight semi-light :foreground "#6e6e6e"))))
   `(org-table ((,class :foreground "#001efd")))
   `(org-tag ((,class (:weight normal :slant italic :inherit fixed-pitch)))) ;;Formatierung der tags
;   `(org-target ((,class (:foreground "#FF6DAF"))))
   `(org-time-grid ((,class (:foreground "#BABABA"))))
...
;   `(light-symbol-face ((,class (:background "#FFFFA0"))))
   `(linum ((,class (:foreground "#9A9A9A" :background "#EDEDED" :inherit 'fixed-pitch))))
