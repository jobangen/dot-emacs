...
(let ((class '((class color) (min-colors 89)))
      ...
      (ol1 '(:height 1.0 :weight bold :foreground "#252525" :inherit fixed-pitch))
      (ol2 '(:height 1.0 :weight bold :foreground "#1e2294" :inherit fixed-pitch))
      (ol3 '(:height 1.0 :weight bold :foreground "#272cbe" :inherit fixed-pitch))
      (ol4 '(:height 1.0 :weight bold :foreground "#4045d8" :inherit fixed-pitch))
      (ol5 '(:height 1.0 :weight bold :foreground "#6a6ee1" :inherit fixed-pitch))
      (ol6 '(:height 1.0 :weight bold :foreground "#6a6ee1" :inherit fixed-pitch))
      (ol7 '(:height 1.0 :slant italic :foreground "#6a6ee1" :inherit fixed-pitch))
      (ol8 '(:height 1.0 :slant italic :foreground "#6a6ee1" :inherit fixed-pitch))
...
;; Latex
   ...
   `(font-latex-sectioning-1-face ((,class (:family "Sans Serif" :height 1.1 :weight bold :foreground "cornflower blue"))))
   `(font-latex-sectioning-2-face ((,class (:family "Sans Serif" :height 1.1 :weight bold :foreground "cornflower blue"))))
