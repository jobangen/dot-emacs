...
(use-package zettelkasten
  ...
  (defhydra hydra-zd (:columns 2 :color pink)
    ...
    ("l" zd-find-file-id-insert "Link ID")
    ("L" zd-find-file-full-title-insert "Link full title")
    ("sl" zd-avy-link-search "search link" :color blue)
    ("sf" zd-search-current-id "seach current file" :color blue)
    ("sd" zd-deft-new-search "search deft " :color blue)
    ("st" zd-avy-tag-search "search tag" :color blue)
