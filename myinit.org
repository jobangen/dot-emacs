...
"#+TITLE: %^{Title}\n#+DATE: %U\n* Keywords\nTODO-tags:\n* Summary\n%?\n\n* Bibliography\n\n* Links")
              ("Z" "Zettel TODO" entry (file+headline "~/Dropbox/db/zk/TODO.txt" "Summary")
"* TODO %^{Task}\n:PROPERTIES:\n:CREATED: %U\n:END:\n[[%l][%f]]\n%?")
))
...
(setq flyspell-tex-command-regexp "\\(\\(begin\\|end\\)[ \t]*{\\|\\(cite[.*]*\\|autocite[.*]*\\|label\\|ref\\|eqref\\|usepackage\\|documentclass\\|addbibresource\\|pagestyle\\|KOMAoptions\\|newclassic\\|printbibliography\\)[ \t]*\\(\\[[^]]*\\]\\)?{[^{}]*\\)")
