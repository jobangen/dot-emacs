...
(bind-key "H-h" 'windmove-left)
(bind-key "H-l" 'windmove-right)
(bind-key "H-j" 'windmove-up)
(bind-key "H-k" 'windmove-down)
#+end_src
...
("z" "Zettel" plain (file (lambda () (capture-report-date-file (expand-file-name zettel-dir))))
 "#+TITLE: %^{Title}
#+DATE: %U
...
(defvar bh/organization-task-id "fec8faf6-41b8-4adf-b4cb-18b7c673f08b")
