...
(defun capture-report-date-file (path)
  (let ((name (read-string "Name: ")))
    (expand-file-name (concat path name ".txt"))))
  ...
  (let*
   ((key (bibtex-completion-normalize-candidate key))
    ...
    (ref (pcase (downcase (bibtex-completion-get-value "=type=" entry))
           ("article"
            (s-format
             "${author} ${date}: ${title}. In: ${journaltitle}, ${volume}(${number}), ${pages}."
             'bibtex-completion-apa-get-value entry))
           ("inproceedings"
            (s-format
             "${author} ${date}. ${title}. In ${editor}, ${booktitle} (pp. ${pages}). ${location}: ${publisher}."
             'bibtex-completion-apa-get-value entry))
           ("book"
            (s-format
           ...
           ("phdthesis"
            (s-format
             "${author} ${year}: ${title} (Doctoral dissertation). ${school}, ${location}."
             'bibtex-completion-apa-get-value entry))
           ("inbook"
            (s-format
             "${author} ${date}: ${title}. In: [${crossref}] ${location}: ${publisher}, ${pages}"
             'bibtex-completion-apa-get-value entry))
           ("incollection"
            (s-format
             "${author} ${date}: ${title}. In: ${editor} (Hg.): [${crossref}] ${location}: ${publisher}, ${pages}."
             'bibtex-completion-apa-get-value entry))
           ("proceedings"
            (s-format
