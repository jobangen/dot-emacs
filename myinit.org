...
(setq bh/organization-task-id "e01b2848-cfbb-4bfb-b7da-eaec960ee420")
...
#+begin_src emacs-lisp
(use-package helpful
  :bind (("C-ß f" . helpful-callable)
         ("C-ß v" . helpful-variable)
         ("C-ß k" . helpful-key)))
#+end_src
...
(global-set-key (kbd "M-c") 'job/capitalize-last-word)
(global-set-key (kbd "M-l") 'job/downcase-last-word)
#+end_src
