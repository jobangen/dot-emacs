...
(bind-key "H-a" 'windmove-left)
(bind-key "H-d" 'windmove-right)
(bind-key "H-w" 'windmove-up)
(bind-key "H-s" 'windmove-down)

(bind-key "H-j" 'org-metaleft)
(bind-key "H-l" 'org-metaright)
(bind-key "H-i" 'org-metaup)
(bind-key "H-k" 'org-metadown)
#+end_src
...
(defvar bh/organization-task-id "86e2227c-e8bf-4cf7-863f-5c3ddabfcb35")
