...
** org-clock-csv
#+begin_src emacs-lisp
(setq org-clock-csv-header "task;category;date;start;end;duration;effort;tags")

(setq org-clock-csv-row-fmt 'org-clock-csv-job-row-fmt)

(defun org-clock-csv-job-row-fmt (plist)
