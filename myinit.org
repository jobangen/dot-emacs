...
(setq org-agenda-custom-commands
      '((" " "Custom-Agenda"
        ...
        ("t" "Today"
         (
          (tags-todo "orgtaskoverview"
                ((org-agenda-overriding-header (zettelkasten-task-overview-plot))
                 (org-agenda-prefix-format " %i       %?-12t% s [%e] ")
                 (org-agenda-remove-tags t)
                 ))
          (tags-todo "sticky"
                ((org-agenda-overriding-header "Sticky Tasks:")
                 (org-agenda-prefix-format " %i       %?-12t% s [%e] ")
                 (org-agenda-remove-tags t)
                 ))
          (todo "NEXT"
          ...
          (tags-todo (format-time-string "+%YW%W")
          ...
          (tags-todo (concat (format-time-string "+%YW")
                             (format "%02d" (- (string-to-number (format-time-string "%W")) 1))
                             (format-time-string "-%YW%W"))
                     ((org-agenda-overriding-header "Last week's Tasks:")
                      (org-agenda-remove-tags t)
                      (org-agenda-prefix-format " %i       %?-12t% s [%e] ")
                      (org-agenda-skip-function
                       '(org-agenda-skip-entry-if 'todo '("NEXT")))
          ...
          (tags-todo (concat (format-time-string "-%YW%W")
                             (format-time-string "-%YW")
                             (number-to-string (- (string-to-number (format-time-string "%W")) 1))
                             (format-time-string "+{^%YW.*}")
                             )
                     ((org-agenda-overriding-header "This Year's Tasks:")
                      (org-agenda-remove-tags t)
                      (org-agenda-prefix-format " %i       %?-12t% s [%e] ")
                      (org-agenda-skip-function
                       '(org-agenda-skip-entry-if 'todo '("NEXT")))
        ...
        ("w" "Tasks with"
         ((todo "TODO"
           ((org-agenda-overriding-header (concat "Tasks with: " (zettelkasten-ext-get-person-id)))
            (org-agenda-remove-tags t)
            (org-agenda-prefix-format " %i       %?-12t% s [%e] ")
            (org-agenda-skip-function 
             '(org-agenda-skip-entry-if
               'notregexp (concat "zkt:hadAdressat::" zettelkasten-ext-with-agent-id)))))))
        ...
        ("d" "Dissertation"
         ((tags-todo "+diss+einleitung"
                     ((org-agenda-overriding-header "Kapitel: Einleitung")
                      (org-agenda-remove-tags t)
                      (org-tags-match-list-sublevels
                       'indented)))
          (tags-todo "+diss+auctoritas"
                     ((org-agenda-overriding-header "Kapitel: Auctoritas")
                      (org-agenda-remove-tags t)
                      (org-tags-match-list-sublevels
                       'indented)))
          (tags-todo "+diss+ansehensmacht"
           ((org-agenda-overriding-header "Kapitel: Ansehensmacht")
                      (org-agenda-remove-tags t)
                      (org-tags-match-list-sublevels
                       'indented)))
          (tags-todo "+diss+weber"
           ((org-agenda-overriding-header "Kapitel: Weber")
                      (org-agenda-remove-tags t)
                      (org-tags-match-list-sublevels
                       'indented)))
          (tags-todo "+diss+schluss"
           ((org-agenda-overriding-header "Kapitel: Schluss")
                      (org-agenda-remove-tags t)
                      (org-tags-match-list-sublevels
                       'indented)))
          (tags-todo "diss"
                     ((org-agenda-overriding-header "Dissertation")
                      ...
                      (org-agenda-sorting-strategy
                       '(category-up))))))
        ("z" "Zettelkasten"
         ((tags-todo "+zkt+followup"
                     ((org-agenda-overriding-header "Followup")
                      (org-agenda-remove-tags t)))
          (tags-todo "+zkt+refile-inbox"
          ...
          (tags-todo "+zkt+inbox"
                     ((org-agenda-overriding-header "Inbox")
                      (org-agenda-remove-tags t)))
          (tags-todo "+zkt+self"
                     ((org-agenda-overriding-header "Self")
                      (org-agenda-remove-tags t)))
          (tags-todo "+zkt-refile-followup-self"
        ...
        ("K" "Kanban"
         ((tags-todo "+KBtodo"
                ((org-agenda-overriding-header "1. Todo:")
                 (org-agenda-remove-tags t)))
          (tags-todo "+KBstarted"
                ((org-agenda-overriding-header "2. Started:")
                 (org-agenda-remove-tags t)))
          (tags-todo "+KBblocked"
                ((org-agenda-overriding-header "3. Blocked:")
                 (org-agenda-remove-tags t)))
          (tags-todo "+KBreview"
                ((org-agenda-overriding-header "4. Review:")
                 (org-agenda-remove-tags t)))
          (tags "TODO=\"PROJ\"-KBreview-KBblocked-KBstarted-KBtodo-longterm"
...
#+begin_src emacs-lisp
  ...
  (setq org-todo-keywords
        (quote ((sequence "TODO(t)" "NEXT(n!)" "|" "DONE(d)")
                (sequence "AREA(a)" "PROJ(p)" "ISSUE(i)" "WAITING(w@/!)" "HOLD(h@/!)" "|"  "DELEGATED(D@/!)" "CANCELLED(c@/!)"))))
  ...
  (setq org-todo-state-tags-triggers
        (quote
         ((done ("today") ("KBbacklog") ("KBtodo") ("KBstarted") ("KBblocked") ("KBreview"))
          ("WAITING" ("today"))
          ("HOLD" ("KBbacklog") ("KBtodo") ("KBstarted") ("KBblocked") ("KBreview"))
          ("TODO" ("today")))))


  ;; Formatierung für TODO-tags
  (setq org-todo-keyword-faces ;; in theme!
        (quote (("AREA" :foreground "blue" :weight semi-bold)
                ("PROJ" :foreground "dark red" :weight semi-bold)
                ("ISSUE" :foreground "blue" :weight semi-bold)
...
("d" "Daily Tasks" entry (function org-journal-find-location) (file "~/templates/org/daily.org") :immediate-finish t :jump-to-captured t)

("t" "Todo" entry (file+headline org-default-notes-file "Tasks")
"* TODO %^{Task} %^G
SCHEDULED: %(org-insert-time-stamp (org-read-date nil t))<2024-03-05 tir.>
:PROPERTIES:
:CUSTOM_ID: %(format-time-string \"%Y-%m-%dT%H%M%S.%1N\")
:RDF_TYPE: zkt:Task
:GENERATED_AT_TIME: %(concat (format-time-string \"%Y-%m-%dT%H:%M:%S+\") (job/current-timezone-offset-hours)) 
:TURTLE: zkt:hadAdressat::@me
:END:
%?")
...
("I" "Issue" entry (file+headline org-default-notes-file "Tasks")
 "* TODO %i :issue:
:PROPERTIES:
:CUSTOM_ID: %(format-time-string \"%Y-%m-%dT%H%M%S.%1N\")
:RDF_TYPE: zkt:Task
...
("m" "mail todo" entry (file "inbox.org")
 "* TODO %^{Task}  :@mail:
SCHEDULED: %t
:PROPERTIES:
:CREATED: %U
...
"* PROJ %^{Projekt}   :KBbacklog:
:PROPERTIES:
:CREATED: %U
:CATEGORY:  %^{Category|wiss|arbeit|pers}
:END:\n** Information\n** Notes\n** Tasks"
)

("D" "Norsk" entry (file "~/proj/languages/norsk.org")
"* %^{Titel}    :drill:
:PROPERTIES:
...
(setq org-global-properties
      (quote (("Effort_ALL" . "00:10 00:15 00:20 00:30 00:45 01:00 01:30 02:00 03:00 04:00 05:00 06:00 07:00 08:00 16:00 32:00 40:00 48:00")
              ("STYLE_ALL" . "habit"))))
#+end_src
** clocking
*** config
...
(setq bh/organization-task-id "e90846b5-1cbd-47e0-a9df-fa65cedb6616")
...
(defhydra hydra-word (:color blue :columns 1)
  ...
  ("ö" sdcv-search-pointer+ "sdcv")
  ("C-ö" sdcv-search-input "sdcv"))
#+end_src
...
(unless windows-p (define-key dired-mode-map "Y" 'my/ora-dired-rsync))
...
;; start directory
(defvar my/move-file-here-start-dir (expand-file-name "~/tmp/2del"))
...
(defun pdfgrep-default-command ()
 "pdfgrep -i -H -n TERM  ~/archive/texts/*.pdf")
