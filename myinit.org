...
;;https://github.com/mattfidler/my-emacs-startup/blob/master/startup-org.org
  ...
  (defvar bh/organization-task-id "10bba002-8ca6-458d-96eb-74bfdae2f238")
...
(defhydra hydra-zettelkasten (:color pink
                              :columns 4)
"Zettelkasten"
;;General
("C-s" counsel-grep-or-swiper "swiper")
("b" ivy-bibtex "bibtex")
("c" org-brain-build-caches "Build Cache")
("C" org-brain-invalidate-all-caches "Invalidate Cache")
("d" zettelkasten-open-dir "Dir")
("k" projectile-kill-buffers "kill buffers")
("q" zettelkasten-ag-query "query")
("Q" zettelkasten-ag-thing-at-point "query at point")
("v" org-brain-visualize "visualize" :color blue)
("x" zettelkasten-txt-query "txt query")
("z" zettelkasten-new-zettel "Zettel" :color blue)
;; Zettel
("f" zettelkasten-finish-zettel "finish")
("j" join-line "join-line")
...
(defun job/vpn-zedat-shell ()
  (interactive)
  (ignore-errors (kill-buffer "*vpn-shell*"))
  (shell)
