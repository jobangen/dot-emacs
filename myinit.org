...
(use-package counsel
  ...
  :bind (("C-s" . counsel-grep-or-swiper)
         ...
         ("C-M-s" . my/counsel-ag-project-at-point)
         ("C-x l". counsel-locate)
         ("M-y" . counsel-yank-pop)
         :map ivy-minibuffer-map
         ("M-y" . ivy-next-line))
  :config
    (defun my/counsel-ag-project-at-point () ;;http://pastebin.com/Gtx9a1N0
...
(use-package ivy-bibtex
 :bind ("<f5>" . ivy-bibtex)
       ("C-<f5>" . ivy-resume)
 :config
  (setq ivy-bibtex-default-action 'bibtex-completion-insert-key) ;;funktioniert nicht
