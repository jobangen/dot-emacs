...
(defun xrandr-preset-topoi ()
  (interactive)
    (shell-command "xrandr --output eDP1 --mode 1366x768 --output HDMI1 --mode 1680x1050 --left-of eDP1")
