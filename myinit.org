...
'("less" "tmux" "htop" "top" "bash" "zsh" "fish" "watch"))
#+end_src
...
(use-package paperless
  :config
   (setq paperless-capture-directory "~/capture")
